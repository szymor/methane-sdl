...
// Misc Global Data
//------------------------------------------------------------------------------
METHANE_RGB StdPalette[SCR_COLS] =
	{
		{0x00,0x00,0x00},{0x53,0xCF,0xFF},
		{0x43,0xAF,0xEF},{0x33,0x8F,0xDF},
		{0xE3,0xB7,0xDF},{0xB7,0x6F,0xB7},
		{0x87,0x37,0x8F},{0x53,0x13,0x67},
		{0x57,0xFF,0x00},{0x27,0x6F,0xCF},
		{0x33,0xC7,0x00},{0x1B,0x53,0xBF},
		{0x17,0x93,0x00},{0x13,0x3B,0xB3},
		{0x07,0x5F,0x00},{0x0B,0x23,0x93},
		{0xF3,0xCF,0xD7},{0x07,0x13,0x73},
		{0x00,0x07,0x53},{0x00,0x00,0x33},
		{0xDB,0x93,0x9B},{0x00,0x2B,0x00},
		{0x9B,0x37,0x17},{0x83,0x27,0x0F},
		{0xC7,0x63,0x63},{0x6F,0x17,0x07},
		{0x5B,0x0B,0x07},{0x47,0x07,0x00},
		{0xAF,0x47,0x37},{0x00,0x00,0x00},
		{0x2B,0x00,0x3F},{0xFF,0xFF,0xFF},


{0x00,0x00,0x00},{0x00,0xA3,0xFF},{0x00,0x93,0xE7},{0x00,0x83,0xCF},
{0xB3,0x73,0xDF},{0x8B,0x4B,0xBF},{0x67,0x27,0xA3},{0x47,0x0F,0x87},
{0x8B,0xBF,0x00},{0x00,0x73,0xB7},{0x5F,0x97,0x00},{0x00,0x63,0x9F},
{0x3F,0x73,0x00},{0x00,0x53,0x87},{0x23,0x4F,0x00},{0x00,0x43,0x6F},
{0xF3,0xCF,0x97},{0x00,0x33,0x57},{0x00,0x23,0x3F},{0x00,0x17,0x27},
{0xDB,0xB3,0x77},{0x0F,0x2B,0x00},{0x8F,0x6F,0x2B},{0x73,0x57,0x17},
{0xC7,0x9F,0x5B},{0x57,0x43,0x0B},{0x3B,0x2F,0x00},{0x23,0x1B,0x00},
{0xAB,0x87,0x3F},{0x00,0x00,0x00},{0x2B,0x00,0x6B},{0xFF,0xFF,0xFF}
	
	};


METHANE_RGB TitlePalette[32] =
	{
		{0x4B,0x00,0x5B},{0x53,0xC3,0xF3},
		{0x43,0xA3,0xE3},{0x33,0x83,0xD3},
		{0x23,0x63,0xC3},{0x13,0x53,0xB3},
		{0x13,0x33,0xB3},{0x00,0x23,0x93},
		{0x00,0x13,0x73},{0x00,0x00,0x53},
		{0x00,0x00,0x33},{0x00,0xB7,0x00},
		{0x00,0x8F,0x00},{0x00,0x6B,0x00},
		{0x00,0x47,0x00},{0x00,0x23,0x00},
		{0xF3,0xC3,0xD3},{0xD3,0x93,0x93},
		{0xC3,0x63,0x63},{0xA3,0x43,0x33},
		{0x93,0x33,0x13},{0x83,0x23,0x00},
		{0x63,0x13,0x00},{0x53,0x00,0x00},
		{0x00,0x73,0x00},{0x00,0x00,0x00},
		{0x93,0x43,0x93},{0x83,0x33,0x83},
		{0x73,0x23,0x73},{0x53,0x13,0x63},
		{0x33,0x13,0x43},{0xFF,0xFF,0xFF}
	};
...
static PARTYOFFS	party_00 = {SPR_ENDSPR_1+0x00,0x0000,static_cast<int>(0x0000)};
static PARTYOFFS	party_01 = {SPR_ENDSPR_1+0x01,0x0010,static_cast<int>(0x0000)};
static PARTYOFFS	party_02 = {SPR_ENDSPR_1+0x02,0x0030,static_cast<int>(0x0000)};
static PARTYOFFS	party_03 = {SPR_ENDSPR_1+0x03,0x0050,static_cast<int>(0x0000)};
static PARTYOFFS	party_04 = {SPR_ENDSPR_1+0x04,0x0070,static_cast<int>(0x0010)};
static PARTYOFFS	party_05 = {SPR_ENDSPR_1+0x05,0x0000,static_cast<int>(0x0000)};
static PARTYOFFS	party_06 = {SPR_ENDSPR_1+0x06,0x0020,static_cast<int>(0x0000)};
static PARTYOFFS	party_07 = {SPR_ENDSPR_1+0x07,0x0000,static_cast<int>(0x0000)};
static PARTYOFFS	party_08 = {SPR_ENDSPR_1+0x08,0x0028,static_cast<int>(0x0002)};
static PARTYOFFS	party_09 = {SPR_ENDSPR_1+0x09,0x0048,static_cast<int>(0x0002)};
static PARTYOFFS	party_0a = {SPR_ENDSPR_1+0x0a,0x0058,static_cast<int>(0x0002)};
static PARTYOFFS	party_0b = {SPR_ENDSPR_1+0x0b,0x0000,static_cast<int>(0x0000)};
static PARTYOFFS	party_0c = {SPR_ENDSPR_1+0x0c,0x0020,static_cast<int>(0xFFFFFFD0)};
static PARTYOFFS	party_0d = {SPR_ENDSPR_1+0x0d,0x0040,static_cast<int>(0x0000)};
static PARTYOFFS	party_0e = {SPR_ENDSPR_1+0x0e,0x0000,static_cast<int>(0x0000)};
static PARTYOFFS	party_0f = {SPR_ENDSPR_1+0x0f,0x005E,static_cast<int>(0xFFFFFFF2)};
static PARTYOFFS	party_10 = {SPR_ENDSPR_1+0x10,0x007E,static_cast<int>(0xFFFFFFFA)};
static PARTYOFFS	party_11 = {SPR_ENDSPR_1+0x11,0x008E,static_cast<int>(0xFFFFFFF9)};
static PARTYOFFS	party_12 = {SPR_ENDSPR_1+0x12,0x0092,static_cast<int>(0x000B)};
static PARTYOFFS	party_13 = {SPR_ENDSPR_1+0x13,0x00B2,static_cast<int>(0xFFFFFFFB)};
static PARTYOFFS	party_14 = {SPR_ENDSPR_1+0x14,0x00C2,static_cast<int>(0xFFFFFFFA)};
static PARTYOFFS	party_15 = {SPR_ENDSPR_1+0x15,0x0000,static_cast<int>(0x0000)};
static PARTYOFFS	party_16 = {SPR_ENDSPR_1+0x16,0x0020,static_cast<int>(0x0008)};
static PARTYOFFS	party_17 = {SPR_ENDSPR_1+0x17,0x0020,static_cast<int>(0x0000)};
static PARTYOFFS	party_18 = {SPR_ENDSPR_1+0x18,0x0180,static_cast<int>(0x0010)};
static PARTYOFFS	party_19 = {SPR_ENDSPR_1+0x19,0x0000,static_cast<int>(0x0000)};
static PARTYOFFS	party_1a = {SPR_ENDSPR_1+0x1a,0x0020,static_cast<int>(0x0000)};
static PARTYOFFS	party_1b = {SPR_ENDSPR_1+0x1b,0x0000,static_cast<int>(0x0010)};
static PARTYOFFS	party_1c = {SPR_ENDSPR_1+0x1c,0x0010,static_cast<int>(0x0)};
static PARTYOFFS	party_1d = {SPR_ENDSPR_1+0x1d,0x0030,static_cast<int>(0xFFFFFFF0)};
